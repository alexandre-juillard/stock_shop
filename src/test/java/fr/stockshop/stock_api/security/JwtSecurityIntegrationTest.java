...
/**
 * Vérifie que la configuration Spring Security + JWT respecte les critères
 * d'acceptation du ticket INF-003 :
 * <ul>
 *     <li>AC-1 : /api/auth (sauf /logout) accessible sans token</li>
 *     <li>AC-2 : toute autre ressource retourne 401 sans token valide</li>
 *     <li>AC-4 : le JWT contient userId, email (sub), iat, exp</li>
 *     <li>AC-5 : un token expiré retourne 401</li>
 *     <li>AC-6 : un token à la signature altérée retourne 401</li>
 *     <li>AC-7 : le filtre authentifie correctement une requête avec un token valide</li>
 * </ul>
 */
@SpringBootTest
...
class JwtSecurityIntegrationTest {
	...
	void logoutSucceedsWithValidAccessToken() throws Exception {
		...
		mockMvc.perform(post("/api/auth/logout")
						...
						.contentType(MediaType.APPLICATION_JSON)
						.content(objectMapper.writeValueAsString(Map.of("refreshToken", "does-not-matter"))))
	...
	void expiredTokenIsRejected() throws Exception {
		...
		String expiredToken = buildRawToken(email, Instant.now().minusSeconds(3600), Instant.now().minusSeconds(60));
